...
export default function AdminDashboardClient({
  ...
  // --- TAB RENDER FUNCTIONS FOR COGNITIVE COMPLEXITY REDUCTION ---
  ...
  const renderModeratorDashboardTab = () => {
    return (
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case 'moderator_dashboard': return renderModeratorDashboardTab();
      case 'stray_cats': return renderStrayCatsTab();
      case 'tnr_campaigns': return renderTnrCampaignsTab();
      case 'queries_log': return renderQueriesLogTab();
      case 'gamification': return renderGamificationTab();
      case 'audits': return renderAuditsTab();
      case 'gdpr': return renderGdprTab();
